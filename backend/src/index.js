...
mongoose.connect('mongodb://localhost/theseed', (err, db) => {
    if(err){console.error(err)}else{console.log("\x1b[35m",'Connected to mongodb server')}
})
...
if(process.env.NODE_ENV !== "development"){
    ...
    redirectApp.use('*', (req,res) => {
        res.redirect('https://theseed.com'+req.originalUrl)
    })
